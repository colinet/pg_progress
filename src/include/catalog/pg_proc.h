...
DATA(insert OID = 3403 (  pg_progress			  PGNSP PGUID 12 1 100 0 0 f f f f t t s r 2 0 2249 "23 23" "{23,23,23,23,23,23,23,23}" "{i,i,o,o,o,o,o,o}" "{pid,verbose,pid,lineid,indent,property,value,unit}" _null_ _null_ pg_progress _null_ _null_ _null_ ));
